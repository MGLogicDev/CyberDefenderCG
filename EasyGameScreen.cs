...
{
    public partial class EasyGameScreen : Form
    {
        ...
        public EasyGameScreen(Rectangle previousBounds, User activeUser)
        {
            InitializeComponent();
        ...
        private void ThreatCardPbox_MouseHover(object sender, EventArgs e)
        {
            if (GameEngine != null && GameEngine.CurrentThreat != null)
            {
                AudioManager.PlayClick();
        ...
        private void ThreatCardPbox_MouseLeave(object sender, EventArgs e)
        {
